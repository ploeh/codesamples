...
namespace Ploeh.Samples.Commerce.Domain.Tests.Unit
{
    public class CommandHandlerTests
    {
        ...
        public void IdentityLaw(string input)
        {
            ...
            var sut = new DelegatingCommandHandler<string>(observations.Add);

            T id<T>(T x) => x;
            var projection = sut.ContraMap<string, string>(id);
        ...
        public void CompositionLaw(string input)
        {
            ...
            var sut = new DelegatingCommandHandler<TimeSpan>(observations.Add);
